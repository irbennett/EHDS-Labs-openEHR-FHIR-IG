...
Logical: DvMultimedia
Parent: DV_MULTIMEDIA
Id: DvMultimedia
* ^version = "1.0.0"
* . ^short = "Multimedia"
...
Logical: DvProportion
Parent: DV_PROPORTION
Id: DvProportion
* ^version = "1.0.0"
* . ^short = "Proportion"
