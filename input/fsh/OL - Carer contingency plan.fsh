...
* context 1..1 EVENT_CONTEXT "Context" """[at0002] `COMPOSITION.context` - Documents the context information of a healthcare event involving the subject of care and the health system. The context information recorded here are independent of the attributes recorded in the version audit, which document the system interaction context, i.e. the context of a user interacting with the health record system. Healthcare events include patient contacts, and any other business activity, such as pathology investigations which take place on behalf of the patient."""
  ...
  * careJourneyMetadata 0..1 Cluster "Care journey metadata" """[openEHR-EHR-CLUSTER.care_journey_metadata.v0] Tp capture Care plan metadata"""
    * carePlanName 0..1 DvText "Care plan name" """[at0001] The name , preferably coded of the Care plan with which this journey is associated, and against which the composition was updated."""
    * carePlanIdentifier[x] 0..1 DvText or DvIdentifier "Care plan identifier" "at0002: The identifier , preferably coded, of the Care plan with which this journey is associated, and against which the composition was updated."
    * patientJourneyIdentifier[x] 0..1 DvText or DvIdentifier "Patient journey identifier" "at0003: A patient-journey specific identifier i.e unique to a patient's journey along a specific care pathway."
* PersonalResponsibilities 0..1 EVALUATION "Personal responsibilities" """[openEHR-EHR-EVALUATION.personal_responsibilities.v1] Personal responsibilities"""
  ...
  * description 0..1 DvText "Description" """[at0043] """
  * primaryCarerParentalResponsibility 0..1 Cluster "Primary carer /parental responsibility" """[at0005] """
    ...
    * caredForPerson 0..1 DvText "Cared for person" """[at0010] """
    * howLongCanTheyWaitOnTheirOwn 0..1 DvText "How long can they wait on their own" """[at0011] """
    * replacementCarer 0..1 Cluster "Replacement carer" """[at0013] """
      * member 0..1 Cluster "Member" """[openEHR-EHR-CLUSTER.contact_cc.v0] Contacts for patients and organisations (excluding practitioners)."""
        ...
        * additionalInformation 0..1 DvText "Additional information" """[at0013] Indicates a purpose for which the contact can be reached. This field is only appropriate when the archetype is used inside an organisation cluster."""
        * membername 0..* Cluster "Name" """[openEHR-EHR-CLUSTER.name_cc.v0] Name details aligned with FHIR resource."""
          ...
          * contactName 0..1 DvText "Contact name" """[at0009] A text representation of the full name."""
        * telecomContact 0..* Cluster "Telecom contact" """[openEHR-EHR-CLUSTER.telecom_cc.v0] FHIR telecom details."""
          ...
          * contactValue 0..1 DvText "Contact value" """[at0002] The actual contact point details, in a form that is meaningful to the designated communication system (i.e. phone number or email address)."""
        * address 0..* Cluster "Address" """[openEHR-EHR-CLUSTER.address_cc.v0] Address details aligned with FHIR resource."""
          ...
          * street 0..1 DvText "Street" """[at0011] This component contains the house number, apartment number, street name, street direction, P.O. Box number, delivery hints, and similar address information."""
          * street2 0..1 DvText "Street2" """[at0011] This component contains the house number, apartment number, street name, street direction, P.O. Box number, delivery hints, and similar address information."""
          * city 0..1 DvText "City" """[at0012] The name of the city, town, village or other community or delivery center."""
          * county 0..1 DvText "County" """[at0013] The name of the administrative area (county)."""
          * postalCode 0..1 DvText "Postal code" """[at0014] A postal code designating a region defined by the postal service."""
          * country 0..1 DvText "Country" """[at0015] Country - a nation as commonly understood or generally accepted."""
  ...
  * pet 0..* Cluster "Pet" """[at0040] """
    * petDetails 0..1 DvText "Pet details" """[at0041] """
